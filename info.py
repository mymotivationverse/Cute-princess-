...
API_HASH = environ['e17c47f66af6ce385ab8d8fd9974fe96']
BOT_TOKEN = environ['8649195046:AAG1sT6mvOtYSKui9r1ZGFM4jW2aAht4SWk']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('8874980751', '').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1004427480653', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('-1004427480653')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information *
DATABASE_URI = environ.get('mongodb+srv://Pankaj9876:Pankaj9876@cluster0.klljsmr.mongodb.net/?appName=Cluster0', "")
DATABASE_NAME = environ.get('Cluster0', "LazyDeveloper")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('-1004336076887', 0))
LAZY_GROUP_LOGS = int(environ.get('LAZY_GROUP_LOGS', 0))
REQ_CHANNEL = int(environ.get('-1004429117242', '0'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('-1004352536150', '')).split()]
...
URL_SHORTENR_WEBSITE = environ.get('yourdestinationlink.com', 'atglinks.com') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('b22588b960e9ed29dad0f068cfb69dbd844662e2', 'b22588b960e9ed29dad0f068cfb69dbd844662e2')
